...
\begin{CompactItemize}
\item 
static \bf{CRandom} \bf{ran}\label{classCNucleus_878957182a445fb6769a817f312204c1}

\begin{CompactList}\small\item\em pointer to random number generator \item\end{CompactList}\item 
...
\begin{CompactList}\small\item\em specifies tyoe of non\-Statisical decay \item\end{CompactList}\item 
...
bool \bf{b\-Fission}\label{classCNucleus_00d6ffabcecd4cde1b6244071eb06c44}

\begin{CompactList}\small\item\em true if decay resulted in fission \item\end{CompactList}\item 
...
static int \bf{i\-Point} = -1\label{classCNucleus_23b5480a35c7ff00b5f8f2d6c29fab8e}
...
\begin{CompactList}\small\item\em no imf emission is considered \item\end{CompactList}\item 
static int const \bf{n\-Store} = 5000\label{classCNucleus_118e67bc01ead8adddaacf591e374751}

\begin{CompactList}\small\item\em number of evap sub Channels allowed \item\end{CompactList}\item 
...
static \bf{CYrast} \bf{yrast}\label{classCNucleus_8209fa4f2ea236cdd1d7a876e3aba4ee}

\begin{CompactList}\small\item\em gives fission barriers and rotational energies \item\end{CompactList}\item 
static \bf{CScission} \bf{scission}\label{classCNucleus_695aaf5a4264266303601a24b3f19963}

\begin{CompactList}\small\item\em gives scission energeis, etc \item\end{CompactList}\item 
static \bf{CLevel\-Density} \bf{level\-Density}\label{classCNucleus_4cfbd650b378a11c0f35d46c592c5cf4}
...
static \bf{CEvap} \bf{evap}\label{classCNucleus_f4538365ba525bbdbc76b666d94130fe}

\begin{CompactList}\small\item\em stores info on evaporated particles \item\end{CompactList}\item 
static int const \bf{n\-Sub} = 800\label{classCNucleus_b711b8bac4c99b6c029f3f16d4bcbc58}

\begin{CompactList}\small\item\em number of l-waves stores in HF \item\end{CompactList}\item 
static int const \bf{n\-Sub\-Tl} = 80\label{classCNucleus_3e6d3895de4459d52dbf5a7f429cd32d}

\begin{CompactList}\small\item\em number of l-waves stores in HF in sum\-Tl \item\end{CompactList}\item 
...
static int const \bf{n\-Gamma} = 4000\label{classCNucleus_30cc7bc6b82532b20e17606c575b6865}

\begin{CompactList}\small\item\em number of gamma decay modes considered \item\end{CompactList}\item 
static int const \bf{Nproducts} = 180\label{classCNucleus_c5d3dd0a2c063545e93c329e0eeac9aa}

\begin{CompactList}\small\item\em total number of possible decay products from all decays \item\end{CompactList}\item 
static \bf{CNucleus} $\ast$ \bf{all\-Products} [$\,$] = \{0\}\label{classCNucleus_b55cc1672d0c25677adc1319198d8cf0}

\begin{CompactList}\small\item\em array of pointer to all decay products (stable or intermediate) \item\end{CompactList}\item 
static int \bf{i\-Products} = 0\label{classCNucleus_40f4a22fe619c8eac220ed933e208ad7}

\begin{CompactList}\small\item\em number of decay products from all decays \item\end{CompactList}\item 
static int const \bf{Nstable} = 100\label{classCNucleus_a6c39b8870cbaabe1618a567c4ec1ee8}

\begin{CompactList}\small\item\em max number of stable decay products \item\end{CompactList}\item 
static int \bf{i\-Stable} = 0\label{classCNucleus_4a156bc9271ec7bd73e10272c9858af1}

\begin{CompactList}\small\item\em number of stable decay products \item\end{CompactList}\item 
static \bf{CNucleus} $\ast$ \bf{stable\-Products} [$\,$] = \{0\}\label{classCNucleus_5edc539f23e63a07e09837c0cdffb8a7}
...
\begin{CompactList}\small\item\em store the energy emitted in gamma rays \item\end{CompactList}\end{CompactItemize}
...
this is a debugging tool. prints out the various contributions to teh final energy and the energy difference between inital and final states. The latter shoukd be zero is energy is conserved. \index{CNucleus@{CNucleus}!evaporationWidth@{evaporationWidth}}
...
Calculates the total decay widths in Me\-V for light particle evaporation. using the Hauser-Feshbach formulism \index{CNucleus@{CNucleus}!evaporationWidthSS@{evaporationWidthSS}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void CNucleus::excite (float {\em f\-Ex0})\hspace{0.3cm}{\tt  [protected]}}\label{classCNucleus_1ca78241153854a5f7f65d56a794ddf9}
...
\index{excite@{excite}!CNucleus@{CNucleus}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void CNucleus::excite (double {\em d\-Ex0}, double {\em d\-J0})\hspace{0.3cm}{\tt  [protected]}}\label{classCNucleus_9d255e2fe1a40d6462d3073d824b87c7}
...
\index{CNucleus@{CNucleus}!excite@{excite}}
\index{excite@{excite}!CNucleus@{CNucleus}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void CNucleus::excite (double {\em d\-Ex0}, float {\em f\-J0})\hspace{0.3cm}{\tt  [protected]}}\label{classCNucleus_242389d478bc3e8bd7ee2fb4dd42fc74}
...
\index{CNucleus@{CNucleus}!excite@{excite}}
\index{excite@{excite}!CNucleus@{CNucleus}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void CNucleus::excite (float {\em f\-Ex0}, double {\em d\-J0})\hspace{0.3cm}{\tt  [protected]}}\label{classCNucleus_c018f44ae40a1cf10ddf10b68b479baf}
...
\index{CNucleus@{CNucleus}!excite@{excite}}
\index{excite@{excite}!CNucleus@{CNucleus}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void CNucleus::excite (float {\em f\-Ex0}, float {\em f\-J0})\hspace{0.3cm}{\tt  [protected]}}\label{classCNucleus_0e2fb762749d5e980d178161c2d71d07}
...
\item[Parameters:]
\begin{description}
\item[{\em i\-Mode}]1 is E1, 2=E2 \end{description}
\end{Desc}
...
returns a pointer to the Compound nucleus \index{CNucleus@{CNucleus}!getDeltaE@{getDeltaE}}
...
returns the fission scale factor \index{CNucleus@{CNucleus}!getHeavyDaughter@{getHeavyDaughter}}
...
Returns a pointer to the light daughter nucleus if NULL is returned, then this fragment was stable or a fission event stated, in which case the heavy daughter pointer will not be NULL \index{CNucleus@{CNucleus}!getMomentum@{getMomentum}}
...
Returns the multiplicity of neutrons emitted between saddle and scission \index{CNucleus@{CNucleus}!getNumberOfProducts@{getNumberOfProducts}}
...
\end{Desc}
\index{CNucleus@{CNucleus}!hauserFeshbach@{hauserFeshbach}}
...
\end{Desc}
\index{CNucleus@{CNucleus}!isFission@{isFission}}
\index{isFission@{isFission}!CNucleus@{CNucleus}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}bool CNucleus::is\-Fission ()}\label{classCNucleus_1f4f1cc2222fce845eafc42f20744028}


Returns a true value if a fission occurred \index{CNucleus@{CNucleus}!isResidue@{isResidue}}
...
Returns a true value if the event doesn't fission and has an evaporation residue \index{CNucleus@{CNucleus}!LestoneCorrection@{LestoneCorrection}}
...
After executation, the pointer array all\-Products- points to each of the intermediate and final products produced. The array stable\-Products points to just the final stable products. This array can be accessed to get these fragments \index{CNucleus@{CNucleus}!reset@{reset}}
...
set the pointers to the static arrays of products to NULL. \index{CNucleus@{CNucleus}!S2Loop@{S2Loop}}
...
sets the transient time (fission delay) in zs different from the default value. This is a static function. \index{CNucleus@{CNucleus}!setVelocityCartesian@{setVelocityCartesian}}
