...
\begin{CompactList}\small\item\em identifation name \item\end{CompactList}\item 
\bf{CMass} $\ast$ \bf{mass}\label{classCNuclide_e020aeb91f8b7c73332082282cca3961}

\begin{CompactList}\small\item\em mass excess class // mod-TU \item\end{CompactList}\end{CompactItemize}
